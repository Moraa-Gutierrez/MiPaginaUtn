      ...
      <main>
            ...
            <div className="hero-container">
              <div className="hero-content">
                ...
                <div className="hero-cta">
                  <Link to="/register" className="boton boton-1">Comenzar ahora</Link>
        ...
        <section className="presentacion">
          ...
          <div className="contenedor-botones">
            <Link to="/products" className="boton boton-1">Ver Productos</Link>
          ...
          <table border="1" style={{ borderCollapse: 'collapse', width: '100%' }}>
            ...
            <tbody>
              <tr>
                ...
                <td><Link to="/products/category/1">Explorar</Link></td>
              </tr>
              <tr>
                <td>🕯️ Velas</td>
                <td>Aromas que crean ambientes cálidos.</td>
                <td><Link to="/products/category/3">Explorar</Link></td>
              </tr>
              <tr>
                <td>💎 Bijouterie</td>
                <td>Accesorios delicados y modernos.</td>
                <td><Link to="/products/category/2">Explorar</Link></td>
              </tr>
              <tr>
                <td>🧴 Cuidado personal</td>
                <td>Productos pensados para tu bienestar.</td>
                <td><Link to="/products/category/4">Explorar</Link></td>
              </tr>
            </tbody>
          </table>
        </section>
