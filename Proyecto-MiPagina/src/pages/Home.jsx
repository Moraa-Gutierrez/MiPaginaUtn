          ...
          <table border="1" style={{ borderCollapse: 'collapse', width: '100%' }}>
            ...
            <tbody>
              <tr>
                ...
                <td><Link to="/perfumes">Explorar</Link></td>
              </tr>
              <tr>
                <td>🕯️ Velas</td>
                <td>Aromas que crean ambientes cálidos.</td>
                <td><Link to="/velas">Explorar</Link></td>
              </tr>
              <tr>
                <td>💎 Bijouterie</td>
                <td>Accesorios delicados y modernos.</td>
                <td><Link to="/accesorios">Explorar</Link></td>
              </tr>
              <tr>
                <td>🧴 Cuidado personal</td>
                <td>Productos pensados para tu bienestar.</td>
                <td><Link to="/cuidadosdiarios">Explorar</Link></td>
              </tr>
            </tbody>
          </table>
        </section>
